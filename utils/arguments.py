...
def get_args():
    ...
    parser.add_argument('-c', '--config-file', default='./config/exp.yaml', type=str, help="xxx.yaml")
    ...
    vars(args)['dataset_kwargs'] = {
        ...
        'train_list': args.dataset.train_list,
        'test_list': args.dataset.test_list,
        'labeled_num':args.dataset.labeled_num
    }
